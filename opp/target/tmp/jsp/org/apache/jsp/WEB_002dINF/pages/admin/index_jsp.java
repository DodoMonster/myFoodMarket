...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/pages/admin/../commons/base.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <span class=\"titleName\">我家菜市管理服务系统</span>\r\n");
      out.write("                <div class=\"component\">\r\n");
      out.write("                    <span class=\"userName\"><i class=\"fa fa-user\"></i> DodoMonster</span>\r\n");
      out.write("                    <span><i class=\"fa fa-gear\"></i></span>\r\n");
      out.write("                    <span><i class=\"fa fa-sign-out\"></i></span>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </header>\r\n");
      out.write("        <nav>\r\n");
      out.write("            <div class=\"asider-wrapper\">\r\n");
      out.write("                <div id=\"logo\">\r\n");
      out.write("                    <span>H <i class=\"fa fa-diamond\"></i> M E</span>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("                            分类管理\r\n");
      out.write("                            <i class=\"fa fa-sort-desc\"></i>\r\n");
      out.write("                        </a>\r\n");
      out.write("                    </li>\r\n");
      out.write("                    <ul id=\"childUl\">\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/classify?classify=水果\" target=\"adminFrame\"><span class=\"circle\"></span> 水果</a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/classify?classify=蔬菜\" target=\"adminFrame\"><span class=\"circle\"></span> 蔬菜</a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/classify?classify=肉类\" target=\"adminFrame\"><span class=\"circle\"></span> 肉类</a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/classify?classify=干货\" target=\"adminFrame\"><span class=\"circle\"></span> 干货</a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/classify?classify=水产\" target=\"adminFrame\"><span class=\"circle\"></span> 水产</a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/addClassify\" target=\"adminFrame\"><i class=\"fa fa-plus\" id=\"plusBigTag\"></i></a>\r\n");
      out.write("                        </li>\r\n");
      out.write("                    </ul>\r\n");
      out.write("                    <li><a href=\"#\"><i class=\"fa fa-photo\"></i> 图片管理</a></li>\r\n");
      out.write("                    <li><a href=\"#\"><i class=\"fa fa-search\"></i> 搜索框</a></li>\r\n");
      out.write("                    <li><a href=\"#\"><i class=\"fa fa-upload\"></i> 底部栏</a></li>\r\n");
      out.write("                    <li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/CommodityAction/showCommodity\" target=\"adminFrame\"><i class=\"fa fa-users\"></i> 商品管理</a></li>\r\n");
      out.write("                    <li><a href=\"#\"><i class=\"fa fa-user\"></i> 用户管理</a></li>\r\n");
      out.write("                </ul>\r\n");
      out.write("            </div>\r\n");
      out.write("        </nav>\r\n");
      out.write("\r\n");
      out.write("        <iframe id=\"adminFrame\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${adminPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/NavAction/home\" name=\"adminFrame\"  frameborder=\"0\"></iframe>\r\n");
      out.write("\r\n");
